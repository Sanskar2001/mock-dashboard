            ...
            <div className="relative mb-8 max-w-3xl mx-auto">
              <form onSubmit={handleSubmit} className="relative">
                <input
                  ...
                  placeholder="Ask me anything about your authentication metrics"
                  className="w-full px-4 py-3 bg-gray-50 text-gray-900 rounded-xl focus:outline-none focus:ring-1 focus:ring-gray-300 pr-28 text-base border border-gray-200"
                />
                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2">
                  <button
                    type="submit"
                    className="p-2 text-gray-500 hover:text-gray-900 transition-colors duration-200 flex items-center gap-1"
                  >
              ...
              <div className="absolute -bottom-14 left-0 right-0">
                <div className="flex gap-3 justify-center text-sm text-gray-500">
                  <button
                    onClick={() =>
                      handleQuickAction("Show me our revenue analytics")
                    }
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200 border border-gray-200 text-sm"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                  ...
                  <button
                    onClick={() =>
                      handleQuickAction("Show me our user metrics")
                    }
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200 border border-gray-200 text-sm"
                  >
                    <svg
                  ...
                  <button
                    onClick={() =>
                      handleQuickAction("Show me our SCA performance")
                    }
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200 border border-gray-200 text-sm"
                  >
                    <svg
                ...
                <div className="flex items-start gap-4">
                  <div className="h-8 w-8 rounded-full bg-blue-50 flex items-center justify-center">
                    <svg
                      ...
                      fill="currentColor"
                    >
                      <path d="M9.82727273,24 C9.82727273,22.4061111 11.3076364,21.0909091 13.0909091,21.0909091 C14.8741818,21.0909091 16.3545455,22.4061111 16.3545455,24 L9.82727273,24 Z M13.0909091,0 C17.7041818,0 21.8181818,3.77777778 21.8181818,8.44444444 C21.8181818,11.4444444 20.5090909,14.2222222 18.5454545,16.1111111 L18.5454545,19.6666667 L7.63636364,19.6666667 L7.63636364,16.1111111 C5.67272727,14.2222222 4.36363636,11.4444444 4.36363636,8.44444444 C4.36363636,3.77777778 8.47763636,0 13.0909091,0 Z" />
                    </svg>
                  </div>
