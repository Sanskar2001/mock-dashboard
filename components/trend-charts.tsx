...
import { ReusableChart } from "../path-to-reusable-chart";
...
export function TrendCharts() {
  ...
  const platformColors = ["#4299E1", "#10B981", "#F59E0B"];
  const deviceColors = ["#8B5CF6", "#EC4899", "#F97316"];
  const issuerColors = ["#EF4444", "#6366F1", "#06B6D4"];
  const exemptionColors = ["#84CC16", "#14B8A6", "#F43F5E"];
    ...
    <div className="grid gap-6">
      <div className="grid md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Percentage of payments with exemption requests
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ReusableChart
              title="Exemption Request Rate by Card Network"
              subtitle="Percentage of transactions with exemption requests"
              data={exemptionRequestData}
              dataKeys={["Visa", "Mastercard", "Amex"]}
              colors={exemptionColors}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Percentage of exemption requests approved
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ReusableChart
              title="Exemption Approval Rate by Issuer"
              subtitle="Percentage of approved exemption requests"
              data={exemptionApprovalData}
              dataKeys={["HSBC", "Barclays", "Santander", "BNP"]}
              colors={issuerColors}
              valueFormatter={(value) => `${value}%`}
              yAxisDomain={[0, 100]}
              yAxisTicks={[0, 25, 50, 75, 100]}
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            <ReusableChart
              ...
              subtitle="Percentage of successful authentications"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Percentage of users who abandoned during checkout
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ReusableChart
              title="User Drop-off Rate by Device Type"
              subtitle="Percentage of users abandoning authentication"
              data={dropOffData}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How transaction amount affects key metrics
          </CardDescription>
        </CardHeader>
        <CardContent>
